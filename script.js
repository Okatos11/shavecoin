document.addEventListener('DOMContentLoaded', () => {
    ...
    function showLeaderboard() {
        ...
        // Získání existujících skóre
        let scores = JSON.parse(localStorage.getItem('shavingScores') || '[]');
        scores.push(score);
        
        // Seřazení podle času
        scores.sort((a, b) => parseFloat(a.time) - parseFloat(b.time));
        
        // Uložení všech skóre (bez omezení na top 10)
        localStorage.setItem('shavingScores', JSON.stringify(scores));
